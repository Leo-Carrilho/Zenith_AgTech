    ...
    >
      ...
      >
        ...
        <span className={styles.uploadVisual} aria-hidden="true">
          {disabled ? (
            <LoaderCircle className={`${styles.uploadGlyph} ${styles.uploadGlyph_loading}`} />
          ) : (
            <Upload className={styles.uploadGlyph} strokeWidth={2.2} />
          )}
        </span>
      ...
      {arquivo && (
        <div className={styles.uploadFileCard}>
          ...
          >
            <span className={disabled ? styles.uploadProgress_loading : ""}></span>
          </div>
        </div>
      )}
